...
export default function Home() {
  return (
    <div className="createcart  transition-transform duration-150 ease-in-out absolute flex items-center h-[50vh] w-[calc(80vw)]  left-[calc(19vw)] overflow-clip border border-blue-200 bg-[rgba(156,184,233,0.22)] bg-opacity-90 shadow-[0_4px_30px_rgba(0,0,0,0.1)] backdrop-blur-md">
      <NavLink
        to="/Create"
